...
public class LogTimeData : MonoBehaviour {	
	...
	/* the event list*/
	public static string stepSuccessEvent = "hit_target";		//only set for the person who achive the success
	public static string stepFailEvent = "time_over";			//only set for the person who take charge of the step 
	...
	/*the state list*/
	private static string stepSuccessState = "one_success_step";			//one step
	private static string stepFailedState = "one_failed_step";			//one step
	private static string taskState = "time_for_current_task";			//one task
	private static string dragState = "draging_block";		//mouse down, block not move--unsuccess movement
	private static string moveState = "moving_block_successfully";		//block moving
	private static string rotateState = "rotating_block";	//block rotate 
	private static string silenceState = "no_movement";	//start of task, or end of previous mouse up, untill the new mouse down
	private static string interTaskState = "move_in_seconds";	//the state between the two task
	private static string interStepState = "move_in_seconds";	//not 0 for the two feedbacks
